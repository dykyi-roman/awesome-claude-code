---
name: n-tier-arch-knowledge
description: Classical N-Tier (4-layer) Architecture knowledge base. Presentation → Application → Domain → Infrastructure with strict downward calls; Repository implementations in Infrastructure. Distinct from `layer-arch-knowledge` (3-layer Domain-centric, repositories inside Domain) and `clean-arch-knowledge` (dependency inversion via ports/adapters). Provides patterns, antipatterns, and PHP-specific guidelines for N-Tier audits.
---
